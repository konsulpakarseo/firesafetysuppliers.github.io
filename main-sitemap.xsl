			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Supplier Fire Safety</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Supplier Fire Safety</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://firesafety.suppliers.id/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
							...
							<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
								...
								<table id="sitemap" cellpadding="3">
									...
									<thead>
										<tr>
											<th width="80%">URL</th>
											<th width="5%">Images</th>											<th title="Last Modification Time" width="15%">Last Mod.</th>
										</tr>
									</thead>
